...
/// A model artifact with the size and checksum main records in its catalog.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
/// Which hosting service a pinned revision belongs to.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
/// A pinned download source for one model repository.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
...
pub(crate) struct LlamaCppConfig {
    ...
    pub(crate) artifacts: &'static [ArtifactSpec],
    pub(crate) sources: &'static [ModelSource],
}
...
// Pinned artifact and source tables, captured from main's catalog.
const LOCAL_EMBEDDINGGEMMA_300M_ARTIFACTS: [ArtifactSpec; 1] = [ArtifactSpec {
    path: "embeddinggemma-300M-Q8_0.gguf",
    size: 333_590_944,
    sha256: "b5ce9d77a3fc4b3b39ccb5643c36777911cc4eb46a66962eadfa3f5f60490d63",
}];

const LOCAL_EMBEDDINGGEMMA_300M_SOURCES: [ModelSource; 2] = [
    ModelSource {
...
const LOCAL_QWEN3_EMBEDDING_0_6B_ARTIFACTS: [ArtifactSpec; 1] = [ArtifactSpec {
    path: "Qwen3-Embedding-0.6B-Q8_0.gguf",
    size: 639_150_592,
    sha256: "06507c7b42688469c4e7298b0a1e16deff06caf291cf0a5b278c308249c3e439",
}];

const LOCAL_QWEN3_EMBEDDING_0_6B_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_BGE_SMALL_EN_V1_5_ARTIFACTS: [ArtifactSpec; 5] = [
    ArtifactSpec {
        path: "config.json",
        size: 867,
...
const LOCAL_BGE_SMALL_EN_V1_5_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_ALL_MINILM_L6_V2_ARTIFACTS: [ArtifactSpec; 5] = [
    ArtifactSpec {
        path: "config.json",
        size: 794,
...
const LOCAL_ALL_MINILM_L6_V2_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_POTION_RETRIEVAL_32M_ARTIFACTS: [ArtifactSpec; 2] = [
    ArtifactSpec {
...
const LOCAL_POTION_RETRIEVAL_32M_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_POTION_MULTILINGUAL_128M_ARTIFACTS: [ArtifactSpec; 2] = [
    ArtifactSpec {
        path: "model.safetensors",
        size: 512_361_560,
...
const LOCAL_POTION_MULTILINGUAL_128M_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_POTION_CODE_16M_V2_ARTIFACTS: [ArtifactSpec; 2] = [
    ArtifactSpec {
        path: "model.safetensors",
        size: 32_490_072,
...
const LOCAL_POTION_CODE_16M_V2_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_MULTILINGUAL_E5_SMALL_ARTIFACTS: [ArtifactSpec; 4] = [
    ArtifactSpec {
        path: "config.json",
        size: 658,
...
const LOCAL_MULTILINGUAL_E5_SMALL_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_JINA_EMBEDDINGS_V2_BASE_CODE_ARTIFACTS: [ArtifactSpec; 4] = [
    ArtifactSpec {
        path: "config.json",
        size: 1_216,
...
const LOCAL_JINA_EMBEDDINGS_V2_BASE_CODE_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_GTE_MODERNBERT_BASE_ARTIFACTS: [ArtifactSpec; 4] = [
    ArtifactSpec {
        path: "config.json",
        size: 1_184,
...
const LOCAL_GTE_MODERNBERT_BASE_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const LOCAL_NOMIC_EMBED_TEXT_V1_5_ARTIFACTS: [ArtifactSpec; 4] = [
    ArtifactSpec {
        path: "config.json",
        size: 2_538,
...
const LOCAL_NOMIC_EMBED_TEXT_V1_5_SOURCES: [ModelSource; 2] = [
    ModelSource {
        kind: SourceKind::HuggingFace,
...
const CATALOG: [EmbeddingCatalogEntry; 14] = [
    EmbeddingCatalogEntry::LlamaCpp(LlamaCppConfig {
        ...
        context_size: 2_048,
        max_batch_size: 16,
        artifacts: &LOCAL_EMBEDDINGGEMMA_300M_ARTIFACTS,
        sources: &LOCAL_EMBEDDINGGEMMA_300M_SOURCES,
    }),
    EmbeddingCatalogEntry::LlamaCpp(LlamaCppConfig {
        ...
        context_size: 8_192,
        max_batch_size: 8,
        artifacts: &LOCAL_QWEN3_EMBEDDING_0_6B_ARTIFACTS,
        sources: &LOCAL_QWEN3_EMBEDDING_0_6B_SOURCES,
    }),
    ...
    EmbeddingCatalogEntry::TransformersJs(TransformersConfig {
        ...
        max_batch_size: 4,
        artifacts: &LOCAL_BGE_SMALL_EN_V1_5_ARTIFACTS,
        sources: &LOCAL_BGE_SMALL_EN_V1_5_SOURCES,
    }),
    EmbeddingCatalogEntry::TransformersJs(TransformersConfig {
        ...
        max_batch_size: 4,
        artifacts: &LOCAL_ALL_MINILM_L6_V2_ARTIFACTS,
        sources: &LOCAL_ALL_MINILM_L6_V2_SOURCES,
    }),
    EmbeddingCatalogEntry::Model2Vec(Model2VecConfig {
        ...
        query_prefix: None,
        document_prefix: None,
        artifacts: &LOCAL_POTION_RETRIEVAL_32M_ARTIFACTS,
        sources: &LOCAL_POTION_RETRIEVAL_32M_SOURCES,
    }),
    EmbeddingCatalogEntry::Model2Vec(Model2VecConfig {
        ...
        query_prefix: None,
        document_prefix: None,
        artifacts: &LOCAL_POTION_MULTILINGUAL_128M_ARTIFACTS,
        sources: &LOCAL_POTION_MULTILINGUAL_128M_SOURCES,
    }),
    EmbeddingCatalogEntry::Model2Vec(Model2VecConfig {
        ...
        query_prefix: None,
        document_prefix: None,
        artifacts: &LOCAL_POTION_CODE_16M_V2_ARTIFACTS,
        sources: &LOCAL_POTION_CODE_16M_V2_SOURCES,
    }),
    EmbeddingCatalogEntry::TransformersJs(TransformersConfig {
        ...
        max_input_tokens: 512,
        max_batch_size: 4,
        artifacts: &LOCAL_MULTILINGUAL_E5_SMALL_ARTIFACTS,
        sources: &LOCAL_MULTILINGUAL_E5_SMALL_SOURCES,
    }),
    EmbeddingCatalogEntry::TransformersJs(TransformersConfig {
        ...
        max_input_tokens: 8_192,
        max_batch_size: 2,
        artifacts: &LOCAL_JINA_EMBEDDINGS_V2_BASE_CODE_ARTIFACTS,
        sources: &LOCAL_JINA_EMBEDDINGS_V2_BASE_CODE_SOURCES,
    }),
    EmbeddingCatalogEntry::TransformersJs(TransformersConfig {
        ...
        max_input_tokens: 8_192,
        max_batch_size: 2,
        artifacts: &LOCAL_GTE_MODERNBERT_BASE_ARTIFACTS,
        sources: &LOCAL_GTE_MODERNBERT_BASE_SOURCES,
    }),
    EmbeddingCatalogEntry::TransformersJs(TransformersConfig {
        ...
        max_input_tokens: 8_192,
        max_batch_size: 2,
        artifacts: &LOCAL_NOMIC_EMBED_TEXT_V1_5_ARTIFACTS,
        sources: &LOCAL_NOMIC_EMBED_TEXT_V1_5_SOURCES,
    }),
];
